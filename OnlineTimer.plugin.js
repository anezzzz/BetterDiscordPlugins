/**
 ...
 module.exports = !global.ZeresPluginLibrary ? class {
     ...
     class Timer extends React.Component {
         ...
         render() {
             return React.createElement("div", { className: "onlineTimer" }, `Time elapsed: ${new Date(this.state.delta).toISOString().substr(11, 8)}`);
         }
     };
     ...
     class plugin extends Plugin {
         ...
         onStart() {
             ...
             PluginUtilities.addStyle("onlinetimer", `
            .onlineTimer {
         ...
         onStop() {
             Patcher.unpatchAll();
             PluginUtilities.removeStyle("onlinetimer");
         }
         ...
         patch() {
             Patcher.after(PanelSubtext, "default", (_, [props], ret) => {
                 ...
                 ret.props.children = [
                     props.children,
                     React.createElement(Timer, { className: "onlineTimer" })
                 ]
             })
         }
